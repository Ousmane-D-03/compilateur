...
# 1 "language/Parser_calc.mly"
  
    open Ast

# 26 "language/Parser_calc.ml"
  ...
  and semantic_action =
    [|
      (fun _menhir_env ->
        ...
        let _v : (Ast.expr) = 
# 24 "language/Parser_calc.mly"
                  ( f )
# 235 "language/Parser_calc.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
      ...
      (fun _menhir_env ->
        ...
        let _v =
          ...
          (
# 25 "language/Parser_calc.mly"
                               ( App(f,e,Annotation.create _loc))
# 271 "language/Parser_calc.ml"
           : (Ast.expr))
        in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
      ...
      (fun _menhir_env ->
        ...
        let _endpos = _endpos_e_ in
        let _v : (Ast.expr) = 
# 13 "language/Parser_calc.mly"
                  ( e )
# 297 "language/Parser_calc.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 338 "language/Parser_calc.ml"
        ...
        let _v =
          ...
          let _loc = (_startpos, _endpos) in
          (
# 14 "language/Parser_calc.mly"
                            ( Fun(x,e,Annotation.create _loc) )
# 351 "language/Parser_calc.ml"
           : (Ast.expr))
        in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
      ...
      (fun _menhir_env ->
        ...
        let _v =
          ...
          let _loc = (_startpos, _endpos) in
          (
# 15 "language/Parser_calc.mly"
                                 ( App(e1,e2,Annotation.create _loc) )
# 388 "language/Parser_calc.ml"
           : (Ast.expr))
        in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
      ...
      (fun _menhir_env ->
        ...
        let _v : (Ast.t) = 
# 10 "language/Parser_calc.mly"
             ( [(false,"result",e)] )
# 421 "language/Parser_calc.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
...
# 442 "language/Parser_calc.ml"
        ...
        let _v =
          ...
          let _loc = (_startpos, _endpos) in
          (
# 18 "language/Parser_calc.mly"
          ( Cst_i(i,Annotation.create _loc) )
# 454 "language/Parser_calc.ml"
           : (Ast.expr))
        in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
      ...
      (fun _menhir_env ->
        ...
        let _v =
          let f =
            let b = 
# 28 "language/Parser_calc.mly"
        ( Add )
# 496 "language/Parser_calc.ml"
             in
            
# 31 "language/Parser_calc.mly"
                        ( b )
# 501 "language/Parser_calc.ml"
          ...
          let _loc = (_startpos, _endpos) in
          (
# 19 "language/Parser_calc.mly"
               ( Cst_func(f,Annotation.create _loc) )
# 511 "language/Parser_calc.ml"
           : (Ast.expr))
        in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
      ...
      (fun _menhir_env ->
        ...
        let _v =
          let f = 
# 32 "language/Parser_calc.mly"
        ( UMin )
# 538 "language/Parser_calc.ml"
           in
...
# 569 "language/Parser_calc.ml"
        ...
        let _v =
          ...
          let _loc = (_startpos, _endpos) in
          (
# 20 "language/Parser_calc.mly"
         ( Var(x,Annotation.create _loc) )
# 581 "language/Parser_calc.ml"
           : (Ast.expr))
        in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
      ...
      (fun _menhir_env ->
        ...
        let _endpos = _endpos__3_ in
        let _v : (Ast.expr) = 
# 21 "language/Parser_calc.mly"
                       ( e )
# 621 "language/Parser_calc.ml"
         in
        {
          MenhirLib.EngineTypes.state = _menhir_s;
          MenhirLib.EngineTypes.semv = Obj.repr _v;
