...
val get_type_generic : type_lang -> int list
...
val get_free_type_var : type_lang -> int list
...
val substitute_univ_in_type : int -> type_lang -> type_lang -> type_lang

val apply_subst_in_type :
  (int * type_lang) list -> type_lang -> type_lang
...
val normalise_type : int -> type_lang -> type_lang * (int * int) list

val split_constraint_by_floor :
  int ->
  (type_lang * type_lang) list ->
  (type_lang * type_lang) list * (type_lang * type_lang) list
...
val type_substitution_in_expr : expr -> (int * type_lang) list -> unit
...
val generalize_type_expr : int -> expr -> type_lang
...
val unify : type_lang -> type_lang -> (int * type_lang) list
